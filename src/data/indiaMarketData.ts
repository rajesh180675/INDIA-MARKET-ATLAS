...
// Normalized index: base 1947 = 100. From 1979 onward tracks BSE Sensex
// year-end closing values scaled by 1.827 (so Sensex 100 at 1979 ≈ 183 here).
// Pre-1979 values estimated from RBI Share Price Index and L.C. Gupta research.
const normalizedIndexValues = [
  ...
  169, 183, 183, 236, 316, 398, 448, 475, 1049, 1049,
  808, 1304, 1425, 1915, 3486, 4777, 6113, 7174, 5684, 5636,
  6683, 5581, 9146, 7257, 5959, 6170, 10667, 12063, 17169, 25188,
  37063, 17624, 31905, 37468, 28235, 35492, 38678, 50239, 47716, 48644,
  62220, 65893, 75368, 87237, 106424, 111150, 131977, 142754, 149298,
];
...
export const decadeReturns: DecadeReturn[] = [
  ...
  { period: "1957–1967", nominal: 2.2, real: -5.8 },
  { period: "1967–1977", nominal: 0.4, real: -7 },
  { period: "1977–1987", nominal: 16.9, real: 7.4 },
  { period: "1987–1997", nominal: 23.5, real: 14 },
  { period: "1997–2007", nominal: 18.7, real: 12.7 },
  { period: "2007–2017", nominal: 5.3, real: -1.1 },
  { period: "2017–2025", nominal: 11.6, real: 6.1 },
];

export const rollingWindows: RollingWindow[] = [
  { period: "1979 → 1994", cagr: 27.7, verdict: "Extraordinary" },
  { period: "1985 → 2000", cagr: 13.8, verdict: "Good" },
  { period: "1990 → 2005", cagr: 15.7, verdict: "Good" },
